...
export const facts = [
  {
    en: {
      ...
      desc: "With 5 years of expertise, we provide top-notch yoga instruction.",
    },
    vn: {
      startNumber: "1",
      endNumber: "5",
      ...
      desc: "Với 5 năm kinh nghiệm, chúng tôi cung cấp hướng dẫn yoga hàng đầu.",
    },
  },
  {
    en: {
      ...
      desc: "Join our community of over 5,000 satisfied students from around the world.",
    },
    vn: {
      startNumber: "1",
      endNumber: "5",
      ...
      desc: "Tham gia cùng cộng đồng hơn 5,000 học viên hài lòng trên toàn thế giới.",
    },
  },
  {
    en: {
      ...
      desc: "Our team includes 15+ skilled and dedicated yoga and meditation trainers.",
    },
    vn: {
      startNumber: "1",
      endNumber: "15",
      unit: "",
      title: "Huấn Luyện Viên Kinh Nghiệm",
      desc: "Đội ngũ của chúng tôi bao gồm hơn 15 huấn luyện viên yoga và thiền có kỹ năng và tận tâm.",
    },
  },
  {
    en: {
      ...
      desc: "We offer over 24 classes each month, covering physical, mental, and spiritual practices.",
    },
    vn: {
      startNumber: "1",
      endNumber: "24",
      unit: "",
      title: "Lớp Học Hàng Tháng",
      desc: "Chúng tôi cung cấp hơn 24 lớp học mỗi tháng, bao gồm các bài tập về thể chất, tinh thần và tâm linh.",
    },
  },
];
